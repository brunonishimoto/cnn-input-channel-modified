...
maybe_download(url + csv_files['test_labels'],       os.path.join(csv_dir, csv_files['test_labels']))
...
maybe_download(url + csv_files['test_ids'],          os.path.join(csv_dir, csv_files['test_ids']))
